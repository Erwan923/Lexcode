"""
Simple AI Report Generator for Lexcode
----------------------------------------
...
logger = logging.getLogger("lexcode.simple_ai_reporter")
...
"""
        ...
        report += "\n---\n*This report was automatically generated by Lexcode.*"
    ...
    def create_html_report(self, markdown_content, target, scan_type):
        ...
        try:
            ...
            <body>
                ...
                <div class="footer">
                    <p>Generated by Lexcode on {report_date}</p>
                    <p>© 2025 Lexcode - Automated Security Scanning Tool</p>
                </div>
