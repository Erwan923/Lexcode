...
logger = logging.getLogger("lexcode")

# Define paths
BASE_DIR = Path(__file__).parent.parent
TEMPLATES_DIR = BASE_DIR / "lexcode" / "templates"
...
app = FastAPI(
    title="Lexcode API",
    description="API for Lexcode - Automated Security Scanning Tool",
    version="1.0.0"
)
...
@app.get("/")
async def root():
    return {"message": "Lexcode API - Security Scanning Tool"}
